...
/**
 * Loads a file and executes the code.
...
public class Loader extends PrutOutput{
     ...
     * @throws PrutException error when the code is invalid.
     */
    ...
    private ProgramFactory.Program loadProgram(final InputStream data) throws PrutException {
        ...
        try {
            ...
            program.linkProgram(PrutStd.getInstance().getStandardIO(),new MethodCall("@IO", new ArrayList<>(),1));
